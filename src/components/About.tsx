      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div id="about" className="animate-in fade-in slide-in-from-right-8 duration-1000">
            <h2 className="font-outfit text-4xl md:text-5xl font-bold mb-6 text-foreground">Meet Samira</h2>
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              With over 10 years of experience in nutrition science and wellness coaching, I'm passionate about helping
              people discover the transformative power of proper nutrition.
            </p>
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              My approach combines evidence-based nutritional science with practical, sustainable lifestyle changes. I
              believe that healthy eating should be enjoyable, not restrictive.
            </p>
